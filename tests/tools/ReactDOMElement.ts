...
export class ReactDOMElement {
  ...
  public mountTestComponent<
    T extends React.FunctionComponent<TestComponentProps<TReturn> & TProp>,
    TProp,
    TReturn,
  >(testName: string, testComponent: T, customProps?: TProp): Promise<any> {
