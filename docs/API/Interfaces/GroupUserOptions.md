[API](API/index.md) / [Interfaces](index.md)  / GroupUserOptions
...
• `Optional` **disabled**: [`DisableOptionValueType`](types_options_RenderOptions.md#disableoptionvaluetype) \| (`groupId`: `string` \| `number`, `userId`: `string` \| `number`) => `boolean`
