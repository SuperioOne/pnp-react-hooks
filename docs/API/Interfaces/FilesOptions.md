[API](API/index.md) / [Interfaces](index.md) / FilesOptions
...
• `Optional` **disabled**: [`DisableOptionValueType`](types_options_RenderOptions.md#disableoptionvaluetype) \| (`folderId`: `string`) => `boolean`
