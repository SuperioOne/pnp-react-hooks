...
List GUID Id or title for getting list fields. Keep undefined for web fields. Changing list value repeats request. <ToolTip text="Changing list value repeats request">🚩</ToolTip>
