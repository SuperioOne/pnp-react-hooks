[API](API/index.md) / [Interfaces](index.md) / ItemAttachmentsOptions
...
• `Optional` **disabled**: [`DisableOptionValueType`](types_options_RenderOptions.md#disableoptionvaluetype) \| (`itemId`: `number`, `list`: `string`) => `boolean`
