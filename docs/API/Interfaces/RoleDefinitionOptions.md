[API](API/index.md) / [Interfaces](index.md) / RoleDefinitionOptions
...
• `Optional` **disabled**: [`DisableOptionValueType`](types_options_RenderOptions.md#disableoptionvaluetype) \| (`roleDefId`: `string` \| `number` \| [`RoleType`](RoleType.md)) => `boolean`
