[API](API/index.md) / [Interfaces](index.md) / WebAppOptions
...
• `Optional` **disabled**: [`DisableOptionValueType`](types_options_RenderOptions.md#disableoptionvaluetype) \| (`appId`: `string`) => `boolean`
