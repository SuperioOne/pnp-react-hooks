[API](API/index.md) / [Interfaces](index.md) / FieldOptions
...
• `Optional` **disabled**: [`DisableOptionValueType`](types_options_RenderOptions.md#disableoptionvaluetype) \| (`fieldId`: `string`) => `boolean`
