[API](API/index.md) / [Interfaces](index.md)  / UserOptions
...
• `Optional` **disabled**: [`DisableOptionValueType`](types_options_RenderOptions.md#disableoptionvaluetype) \| (`userId`: `string` \| `number`) => `boolean`
